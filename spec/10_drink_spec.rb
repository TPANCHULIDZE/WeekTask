...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      subject(:drink) { described_class.new('beverage')}

      it 'is your choice of beverage' do
        expect(drink.type).to be('beverage')
      end

      it 'has 16 ounces' do
        expect(drink.ounces).to be(16)
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      subject(:drink) { described_class.new('beverage', 20)}
    ...
    context 'when drink has less than 16 ounces' do
      subject(:drink) { described_class.new('beverage', 10)}

      it 'is not full' do
        expect(drink).not_to be_full
      end
    end
  end
end
