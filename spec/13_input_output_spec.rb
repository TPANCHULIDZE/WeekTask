...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_end) { described_class.new(7, '8')}
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      subject(:game_three) { described_class.new(6, '6', 3) }
    ...
    context 'when count is 4 and over' do
      subject(:game_six) { described_class.new(6, '6', 6) }

      it 'outputs correct phrase' do
        hard_phrase = "That was hard. It took you 6 guesses!\n"
        expect { game_six.final_message }.to output(hard_phrase).to_stdout
      end
    end
  end
end
